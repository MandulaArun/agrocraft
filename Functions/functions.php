<?php
    ...
    if (session_status() === PHP_SESSION_NONE) {
        ...
        $name = (stripos($script, '/FarmerPortal/') !== false || stripos($script, '/auth/Farmer') !== false) ? 'agro_farmer' : 'agro_buyer';
        session_name($name);
        session_start();
    }
            ...
            echo "<div class='column kolum'>
                <div class='img-thumbnail ''>
                     <a href='../BuyerPortal2/Categories.php?type=$product_type'>
                        <img class='rounded mx-auto d-block images' src='../Admin/product_images//$product_image' width='350px' height='200px' alt='image' onerror=this.src='../Images/Website/noimage.jpg'>
                     </a>
                </div>
            </div>";
        }
                ...
                echo "
                    <div class='productbox'>
                        ...
                        <div>
                            ...
                            <p>
                                <a href='../FarmerPortal/FarmerProductDetails.php?id=$id' class='btn btn-sm btn-info'>View</a>
                                <a href='../FarmerPortal/EditProduct.php?id=$id' class='btn btn-sm btn-warning'>Edit</a>
                                <a href='../FarmerPortal/FarmerProductDetails.php?id=$id&delete=1' class='btn btn-sm btn-danger' onclick=\"return confirm('Delete this product?');\">Delete</a>
                            </p>
                        </div>
