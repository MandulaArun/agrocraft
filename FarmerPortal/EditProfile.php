                ...
                <tr align="center">
                    ...
                    <td>
                        <select name = "statevalue" id="states" onchange="state()" tabindex="1" style="width:170px;">
                            ...
                            <?php if (!empty($state)) { ?>
                            <option value="<?php echo htmlspecialchars($state); ?>" selected><?php echo htmlspecialchars($state); ?></option>
                            <?php } ?>
                ...
                <tr align="center">
                    ...
                    <td>
                         <select name="district" id="district">
                             <option><?php echo htmlspecialchars($district ?: 'Select District'); ?></option>
                         </select>
                    </td>
                </tr>
