...
$farmer_query = "SELECT farmer_id, farmer_name, farmer_state, farmer_district, farmer_address FROM farmerregistration WHERE farmer_phone = $sess_phone_number";
...
$farmer_state = $farmer_row['farmer_state'];
$farmer_district = $farmer_row['farmer_district'];
$farmer_address = $farmer_row['farmer_address'];

// Determine location for weather API
$location = $farmer_district . ", " . $farmer_state . ", India";
if (empty($farmer_district) || $farmer_district == "Select District") {
    $location = $farmer_state . ", India";
}
if (empty($farmer_state)) {
    $location = "India";
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Weather Information - Farmer</title>
...
<body>
    <div class="weather-container">
        ...
        <div class="location-info">
            ...
            <p><strong>Farmer:</strong> <?php echo htmlspecialchars($farmer_name); ?></p>
        </div>
