...
$sessphonenumber = intval($_SESSION['phonenumber']);
$sql = "select farmer_name, farmer_phone, farmer_address, farmer_pan, farmer_bank, farmer_state, farmer_district from farmerregistration where farmer_phone = $sessphonenumber";
$run_query = mysqli_query($con, $sql);
$name = $phone = $address = $pan = $bank = $state = $district = '';
if ($run_query && ($row = mysqli_fetch_assoc($run_query))) {
