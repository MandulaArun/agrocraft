...
$farmer_district = "";
if ($fid > 0) {
    $q = "SELECT farmer_name, farmer_phone, farmer_state, farmer_district FROM farmerregistration WHERE farmer_id = $fid LIMIT 1";
                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:35px;">
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="iconsmall.png" style="width: 28px; margin-bottom:  10px;"><b> <?php echo htmlspecialchars($farmer_name); ?></b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" style="margin-left:-9%;"><img src="phoneicon.jpg" style="width: 32px; margin-bottom:  10px;"><b> <?php echo htmlspecialchars($farmer_phone); ?> </b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="location.jpg" style="width: 32px; margin-bottom:  10px;"><b> <?php echo htmlspecialchars(trim($farmer_state) . " , " . trim($farmer_district)); ?></b></h4>
                                </span>
                            </div>
                        </div>
					</div>
                        ...
                        <div class="row">
                                <div class="col-md-12 ">
                                    <span>
                                        ...
                                        <a href='Messages.php?user_id=<?php echo (int)$fid; ?>&user_type=farmer' class='btn btn-warning border-secondary  chat' style='color:black;padding:2px;'><b>Chat Here</b><img src='chat2.png' class='ml-1 mb-1'></a>
                                    </span>
                                    <span>
