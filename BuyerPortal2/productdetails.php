        ...
        while ($rows = mysqli_fetch_array($run_query)) {
            ...
            while ($rows = mysqli_fetch_array($runa_query)) {
                ...
                <div class='container'>
                    ...
                    <div class='row'>
                        <div class='col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12   imageblock border border-dark'> <img src='../Admin/product_images/$product_image' class='d-flex mx-auto btn-dark image' height='290px;' width='380px;' onerror=this.src='../Images/Website/noimage.jpg'><br>
                            <b>
                                <div class='text-center'>
                                    <h2>$product_type</h2>
                                    <br>
                        ...
                        <div class='col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12 text-white' style='background-color:#292b2c;'>
                            ...
                            <div class='details mt-1 text-center'>
                                ...
                                <a href='Messages.php?user_id=$farmer_fk&user_type=farmer' class='btn btn-warning border-secondary  chat' style='color:black;padding:2px;'><b>CHAT HERE</b><img src='chat2.png' class='ml-1 mb-1'></a>
