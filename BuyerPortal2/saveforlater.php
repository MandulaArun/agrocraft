        ...
        <div class="row">
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    ...
                    <img class="card-img-top" src="fruit1.jpeg" alt="Card image cap" onerror=this.src='../Images/Website/noimage.jpg'>
                    <div class="card-body">
            ...
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card  pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    ...
                    <img class="card-img-top pic" src="myfruit1.jfif" alt="Card image cap" onerror=this.src='../Images/Website/noimage.jpg'>
                    <div class="card-body">
                        <h5 class="card-title">Orange</h5>
                        <p class="card-text">PRICE:-20rs/kg</p>
                        <div class="input-group mb-3">
            ...
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2  ">
                    ...
                    <img class="card-img-top" src="myfruit4.jfif" alt="Card image cap" onerror=this.src='../Images/Website/noimage.jpg'>
                    <div class="card-body">
                        <h5 class="card-title">Orange</h5>
                        <p class="card-text">PRICE:-20rs/kg</p>
                        <div class="input-group mb-3">
        ...
        <div class="row mt-3">
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2  ">
                    ...
                    <img class="card-img-top" src="myfruit4.jfif" alt="Card image cap" height="315px" onerror=this.src='../Images/Website/noimage.jpg'>
                    <div class="card-body">
                        <h5 class="card-title">Orange</h5>
                        <p class="card-text">PRICE:-20rs/kg</p>
                        <div class="input-group mb-3">
